...
popBtn.forEach((btn)=>{
    btn.addEventListener('click', function (event) {
        ...
        if(classname=="openBtn btn1"){
            ...
            popContent.innerHTML="Developed a QR code generator using EJS, Node.js, and Express.js. This web app allows users to dynamically create QR codes for various purposes. Leveraged the power of EJS for dynamic content rendering and Express.js for seamless server-side functionality. Successfully implemented a user-friendly interface for efficient QR code generation. Excited to discuss technical details and explore potential collaborations!"
        }
      });
})
